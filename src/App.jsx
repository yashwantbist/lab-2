...
function App() {
  ...
  return (
    <>
     ...
     <Card country ="Indonesia  " name="Gill Air Hotel" image="src/assets/1.jpg" pric="$589/night" rating ="4.8 ★"/> 
      ...
      <Card country ="Bahamas  " name="Bahamas" image="src/assets/4.jpg" pric="$729/night" rating="4.1 ★"/> 
